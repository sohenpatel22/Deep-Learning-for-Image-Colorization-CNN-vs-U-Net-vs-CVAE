...
def train_unet(
    ...
    model = UNet(kernel_size=kernel_size, num_filters=num_filters).to(device)
    ...
    for epoch in range(epochs):
        ...
        if epoch_loss < best_loss:
            ...
            model_path = os.path.join(BASE_DIR, "outputs", "models", "unet_best.pth")
        ...
        if (epoch + 1) % 5 == 0 or epoch == 0:
            ...
            with torch.no_grad():
                ...
                show_images(
                    ...
                    sample_pred,
                    num_images=5,
                    save_path=f"outputs/images/unet_epoch_{epoch+1}.png"
                )

    total_time = time.time() - start_time
    print(f"Training completed in {total_time:.2f} seconds")

    plot_losses(train_losses, save_path="outputs/plots/unet_loss_curve.png")
    ...
    metrics_path = os.path.join(BASE_DIR, "outputs", "metrics", "unet_metrics.json")
